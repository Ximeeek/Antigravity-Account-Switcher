...
export const translations = {
  pl: {
    ...
    extension_installed: "Wtyczka Antigravity została zainstalowana.",
    ...
    extension_title: "Wtyczka Antigravity",
    extension_desc: "Thin client wyświetlający aktywne konto w edytorze.",
    extension_installed_pill: "Zainstalowana",
    extension_not_installed_pill: "Niezainstalowana",
    extension_update_pill: "Dostępna aktualizacja",
    extension_error_pill: "Wymaga uwagi",
    extension_action_reinstall: "Reinstaluj",
    extension_action_install: "Zainstaluj",
    extension_action_update: "Aktualizuj",
    extension_action_repair: "Napraw instalację",
    extension_version: "Wersja {version}",
    extension_no_version: "Brak informacji o wersji",
    extension_installing: "Instalowanie…",
  ...
  en: {
    ...
    extension_installed: "Antigravity extension has been installed.",
    ...
    extension_title: "Antigravity Plugin",
    extension_desc: "Thin client displaying the active account in the editor.",
    extension_installed_pill: "Installed",
    extension_not_installed_pill: "Not installed",
    extension_update_pill: "Update available",
    extension_error_pill: "Requires attention",
    extension_action_reinstall: "Reinstall",
    extension_action_install: "Install",
    extension_action_update: "Update",
    extension_action_repair: "Repair installation",
    extension_version: "Version {version}",
    extension_no_version: "No version info",
    extension_installing: "Installing…",
