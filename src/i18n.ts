...
export const translations = {
  pl: {
    ...
    antigravity_not_detected_title: "Nie wykryto instalacji Antigravity",
    antigravity_not_detected_desc: "Aplikacja nie mogła automatycznie zlokalizować edytora Antigravity. Wskaż folder instalacyjny w ustawieniach, aby umożliwić przełączanie profili.",
    antigravity_not_detected_btn: "Skonfiguruj",
  ...
  en: {
    ...
    antigravity_not_detected_title: "Antigravity installation not detected",
    antigravity_not_detected_desc: "The application could not automatically locate the Antigravity editor. Please point to the installation directory in settings to enable profile switching.",
    antigravity_not_detected_btn: "Configure",
