...
function GlobalQuotaSummary({ profiles }: { profiles: ProfileSummary[] }) {
  let sum5h = 0;
  let count5h = 0;
  let sumWeekly = 0;
  let countWeekly = 0;
          ...
          <div className="global-quota-item">
            ...
            <div className="global-quota-item__value-bar">
              ...
              <div className="global-quota-bar">
                <div 
                  className={`global-quota-bar__fill global-quota-bar__fill--${avg5h < 20 ? "danger" : avg5h < 50 ? "warning" : "success"}`}
                  style={{ width: `${avg5h}%` }}
                />
              </div>
            </div>
        ...
        {avgWeekly !== null && (
          <div className="global-quota-item">
            ...
            <div className="global-quota-item__value-bar">
              ...
              <div className="global-quota-bar">
                <div 
                  className={`global-quota-bar__fill global-quota-bar__fill--${avgWeekly < 20 ? "danger" : avgWeekly < 50 ? "warning" : "success"}`}
